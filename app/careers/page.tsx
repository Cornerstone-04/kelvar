  ...
  return (
    <div className="min-h-screen pt-16.25" style={{ background: "var(--bg)" }}>
      ...
      <div className="px-6 md:px-12 py-20">
        ...
        <h2
          className="font-heading font-black text-white mb-12"
            ...
            >
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-3">
                  <span className="text-[0.6rem] tracking-[0.2em] uppercase text-white/30 font-mono">
                    {role.department}
                  </span>
                ...
                <p className="text-white/40 font-mono text-[0.78rem] leading-relaxed max-w-2xl">
                  {role.summary}
                </p>
              </div>
              <Link
