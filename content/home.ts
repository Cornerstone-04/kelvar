...
export const focus = [
  ...
  },
  {
    id: "03",
    word: "LAND",
    sub: "Ground-based autonomous units built for the environments people live and work in. Whether it's urban streets, remote perimeters, or indoor spaces, Kelvar's land systems navigate complex terrain with precision, bringing intelligent surveillance to every corner.",
    image:
